...
if __name__ == "__main__":
    ...
    inputStart  = 0.7
    inputStop   = 1.05
    inputStepSize  = 0.1e-3



    outDirName = "outputdata/cyclicRingSweep/" + input("Input the Filename and hit Enter to start the acquisition:") #prompting the user for the directory name
    ...
    try:
        ...
        inputSweep = np.arange(start=inputStart, stop=inputStop, step=inputStepSize)
